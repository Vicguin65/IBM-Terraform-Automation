    ...
    <div className="resources">
      <section id="resources" className="section">
        <div className="container">
          ...
          2003, <a target="_blank" href={links[0]['url']}>{links[0]['url']}</a>. Accessed 27 June 2024.
          </p>
          <p className="resources">
          ...
          <a target="_blank" href={links[1]['url']}>{links[1]['url']}</a>. Accessed 27 June 2024.
          </p>
          <p className="resources">
          ...
          20 Sept. 2023, <a target="_blank" href={links[2]['url']}>{links[2]['url']}</a>. Accessed 27 June 2024.
          </p>
          <p className="resources">
          ...
          Medicine, 25 June 2019, <a target="_blank" href={links[3]['url']}>{links[3]['url']}</a>. Accessed 27 June 2024.
          </p>
        </div>
      </section>
    </div>
