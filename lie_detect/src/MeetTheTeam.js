      ...
      <div className="container">
        ...
        <div className="team-members">
          <div className="team-member">
            <img
              src={require("./assets/IMG_0776.jpg")}
              alt="Hazel Yu"
          ...
          <div className="team-member">
            <img
              src={require("./assets/IMG_8934.jpeg")}
              alt="Tyler Du"
              className="team-member-photo"
            />
            <h3>Tyler Du</h3>
            <p className="team-member-title">DevOps Engineer</p>
          </div>
          <div className="team-member">
            <img
              src={require("./assets/IMG_7842_copy_2.jpg")}
              alt="Ritika Brahmadesam"
              className="team-member-photo"
            />
          ...
          <div className="team-member">
            <img
              src={require("./assets/IMG_3173.jpeg")}
              alt="Arnav Mukherjee"
              className="team-member-photo"
            />
